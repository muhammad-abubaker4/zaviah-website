...
export const LinktreeIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={cn("h-5 w-5", className)}>
    <path d="M13.953 6.327c-.354-.435-1.042-.435-1.396 0l-6.527 8.035a.806.806 0 0 0 .698 1.27h13.054a.806.806 0 0 0 .698-1.27l-6.527-8.035zM12.785 2.303a.806.806 0 0 0-1.57 0l-6.527 16.07A.806.806 0 0 0 4.494 20h15.012a.806.806 0 0 0 .806-.627l-6.527-16.07z" />
  </svg>
);
